...
pub fn kms_key_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("key_spec", AttributeType::enum_(carina_core::schema::enum_identity("KeySpec", Some("awscc.kms.Key")), Some(vec!["SYMMETRIC_DEFAULT".to_string(), "RSA_2048".to_string(), "RSA_3072".to_string(), "RSA_4096".to_string(), "ECC_NIST_P256".to_string(), "ECC_NIST_P384".to_string(), "ECC_NIST_P521".to_string(), "ECC_SECG_P256K1".to_string(), "HMAC_224".to_string(), "HMAC_256".to_string(), "HMAC_384".to_string(), "HMAC_512".to_string(), "SM2".to_string(), "ML_DSA_44".to_string(), "ML_DSA_65".to_string(), "ML_DSA_87".to_string(), "ECC_NIST_EDWARDS25519".to_string()]), vec![("SYMMETRIC_DEFAULT".to_string(), "symmetric_default".to_string()), ("RSA_2048".to_string(), "rsa_2048".to_string()), ("RSA_3072".to_string(), "rsa_3072".to_string()), ("RSA_4096".to_string(), "rsa_4096".to_string()), ("ECC_NIST_P256".to_string(), "ecc_nist_p256".to_string()), ("ECC_NIST_P384".to_string(), "ecc_nist_p384".to_string()), ("ECC_NIST_P521".to_string(), "ecc_nist_p521".to_string()), ("ECC_SECG_P256K1".to_string(), "ecc_secg_p256k1".to_string()), ("HMAC_224".to_string(), "hmac_224".to_string()), ("HMAC_256".to_string(), "hmac_256".to_string()), ("HMAC_384".to_string(), "hmac_384".to_string()), ("HMAC_512".to_string(), "hmac_512".to_string()), ("SM2".to_string(), "sm2".to_string()), ("ML_DSA_44".to_string(), "ml_dsa_44".to_string()), ("ML_DSA_65".to_string(), "ml_dsa_65".to_string()), ("ML_DSA_87".to_string(), "ml_dsa_87".to_string()), ("ECC_NIST_EDWARDS25519".to_string(), "ecc_nist_edwards25519".to_string())], None, None))
        ...
        .attribute(
            AttributeSchema::new("origin", AttributeType::enum_(carina_core::schema::enum_identity("Origin", Some("awscc.kms.Key")), Some(vec!["AWS_KMS".to_string(), "EXTERNAL".to_string()]), vec![("AWS_KMS".to_string(), "aws_kms".to_string()), ("EXTERNAL".to_string(), "external".to_string())], None, None))
