...
pub fn ec2_vpc_endpoint_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("dns_options", AttributeType::struct_("DnsOptionsSpecification".to_string(), vec![StructField::new("dns_record_ip_type", AttributeType::string_enum("DnsRecordIpType".to_string(), vec!["ipv4".to_string(), "ipv6".to_string(), "dualstack".to_string(), "service-defined".to_string(), "not-specified".to_string()], Some(carina_core::schema::string_enum_identity("DnsRecordIpType", Some("awscc.ec2.VpcEndpoint.DnsOptionsSpecification"))), vec![("ipv4".to_string(), "ipv4".to_string()), ("ipv6".to_string(), "ipv6".to_string()), ("dualstack".to_string(), "dualstack".to_string()), ("service-defined".to_string(), "service_defined".to_string()), ("not-specified".to_string(), "not_specified".to_string())])).with_description("The DNS records created for the endpoint.").with_provider_name("DnsRecordIpType"),
                    StructField::new("private_dns_only_for_inbound_resolver_endpoint", AttributeType::string_enum("PrivateDnsOnlyForInboundResolverEndpoint".to_string(), vec!["OnlyInboundResolver".to_string(), "AllResolvers".to_string(), "NotSpecified".to_string()], Some(carina_core::schema::string_enum_identity("PrivateDnsOnlyForInboundResolverEndpoint", Some("awscc.ec2.VpcEndpoint.DnsOptionsSpecification"))), vec![("OnlyInboundResolver".to_string(), "only_inbound_resolver".to_string()), ("AllResolvers".to_string(), "all_resolvers".to_string()), ("NotSpecified".to_string(), "not_specified".to_string())])).with_description("Indicates whether to enable private DNS only for inbound endpoints. This option is available only for services that support both gateway and interface endpoints. It routes traffic that originates from the VPC to the gateway endpoint and traffic that originates from on-premises to the interface endpoint.").with_provider_name("PrivateDnsOnlyForInboundResolverEndpoint"),
                    StructField::new("private_dns_preference", AttributeType::string_enum("PrivateDnsPreference".to_string(), vec!["VERIFIED_DOMAINS_ONLY".to_string(), "ALL_DOMAINS".to_string(), "VERIFIED_DOMAINS_AND_SPECIFIED_DOMAINS".to_string(), "SPECIFIED_DOMAINS_ONLY".to_string()], Some(carina_core::schema::string_enum_identity("PrivateDnsPreference", Some("awscc.ec2.VpcEndpoint.DnsOptionsSpecification"))), vec![("VERIFIED_DOMAINS_ONLY".to_string(), "verified_domains_only".to_string()), ("ALL_DOMAINS".to_string(), "all_domains".to_string()), ("VERIFIED_DOMAINS_AND_SPECIFIED_DOMAINS".to_string(), "verified_domains_and_specified_domains".to_string()), ("SPECIFIED_DOMAINS_ONLY".to_string(), "specified_domains_only".to_string())])).with_description("The preference for which private domains have a private hosted zone created for and associated with the specified VPC. Only supported when private DNS is enabled and when the VPC endpoint type is ServiceNetwork or Resource.").with_provider_name("PrivateDnsPreference"),
        ...
        .attribute(
            AttributeSchema::new("ip_address_type", AttributeType::string_enum("IpAddressType".to_string(), vec!["ipv4".to_string(), "ipv6".to_string(), "dualstack".to_string(), "not-specified".to_string()], Some(carina_core::schema::string_enum_identity("IpAddressType", Some("awscc.ec2.VpcEndpoint"))), vec![("ipv4".to_string(), "ipv4".to_string()), ("ipv6".to_string(), "ipv6".to_string()), ("dualstack".to_string(), "dualstack".to_string()), ("not-specified".to_string(), "not_specified".to_string())]))
        ...
        .attribute(
            AttributeSchema::new("vpc_endpoint_type", AttributeType::string_enum("VpcEndpointType".to_string(), vec!["Interface".to_string(), "Gateway".to_string(), "GatewayLoadBalancer".to_string(), "ServiceNetwork".to_string(), "Resource".to_string()], Some(carina_core::schema::string_enum_identity("VpcEndpointType", Some("awscc.ec2.VpcEndpoint"))), vec![("Interface".to_string(), "interface".to_string()), ("Gateway".to_string(), "gateway".to_string()), ("GatewayLoadBalancer".to_string(), "gateway_load_balancer".to_string()), ("ServiceNetwork".to_string(), "service_network".to_string()), ("Resource".to_string(), "resource".to_string())]))
                .create_only()
