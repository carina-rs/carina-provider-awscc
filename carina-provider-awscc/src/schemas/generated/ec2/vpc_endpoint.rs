    ...
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("ip_address_type", AttributeType::StringEnum {
                ...
                identity: Some(carina_core::schema::string_enum_identity("IpAddressType", Some("awscc.ec2.VpcEndpoint"))),
        ...
        .attribute(
            AttributeSchema::new("vpc_endpoint_type", AttributeType::StringEnum {
                ...
                identity: Some(carina_core::schema::string_enum_identity("VpcEndpointType", Some("awscc.ec2.VpcEndpoint"))),
