    ...
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("private_dns_name_options_on_launch", AttributeType::struct_("PrivateDnsNameOptionsOnLaunch".to_string(), vec![StructField::new("enable_resource_name_dns_aaaa_record", AttributeType::bool()).with_provider_name("EnableResourceNameDnsAAAARecord"),
                    ...
                    StructField::new("hostname_type", AttributeType::string_enum("HostnameType".to_string(), vec!["ip-name".to_string(), "resource-name".to_string()], Some(carina_core::schema::string_enum_identity("HostnameType", Some("awscc.ec2.Subnet"))), vec![("ip-name".to_string(), "ip_name".to_string()), ("resource-name".to_string(), "resource_name".to_string())])).with_provider_name("HostnameType")]))
