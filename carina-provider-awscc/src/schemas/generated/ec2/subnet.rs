...
pub fn ec2_subnet_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("block_public_access_states", AttributeType::struct_("BlockPublicAccessStates".to_string(), vec![StructField::new("internet_gateway_block_mode", AttributeType::string_enum("BlockPublicAccessStatesInternetGatewayBlockMode".to_string(), vec!["off".to_string(), "block-bidirectional".to_string(), "block-ingress".to_string()], Some(carina_core::schema::string_enum_identity("BlockPublicAccessStatesInternetGatewayBlockMode", Some("awscc.ec2.Subnet"))), vec![("off".to_string(), "off".to_string()), ("block-bidirectional".to_string(), "block_bidirectional".to_string()), ("block-ingress".to_string(), "block_ingress".to_string())])).with_description("The mode of VPC BPA. Options here are off, block-bidirectional, block-ingress ").with_provider_name("InternetGatewayBlockMode")]))
                .read_only()
        ...
        .attribute(
            AttributeSchema::new("private_dns_name_options_on_launch", AttributeType::struct_("PrivateDnsNameOptionsOnLaunch".to_string(), vec![StructField::new("enable_resource_name_dns_aaaa_record", AttributeType::bool()).with_provider_name("EnableResourceNameDnsAAAARecord"),
                    ...
                    StructField::new("hostname_type", AttributeType::string_enum("PrivateDnsNameOptionsOnLaunchHostnameType".to_string(), vec!["ip-name".to_string(), "resource-name".to_string()], Some(carina_core::schema::string_enum_identity("PrivateDnsNameOptionsOnLaunchHostnameType", Some("awscc.ec2.Subnet"))), vec![("ip-name".to_string(), "ip_name".to_string()), ("resource-name".to_string(), "resource_name".to_string())])).with_provider_name("HostnameType")]))
