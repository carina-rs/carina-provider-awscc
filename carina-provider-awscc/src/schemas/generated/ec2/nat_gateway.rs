...
pub fn ec2_nat_gateway_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("availability_zone_addresses", AttributeType::unordered_list(AttributeType::struct_("AvailabilityZoneAddress".to_string(), vec![StructField::new("allocation_ids", AttributeType::unordered_list(super::allocation_id())).required().with_description("The allocation IDs of the Elastic IP addresses (EIPs) to be used for handling outbound NAT traffic in this specific Availability Zone.").with_provider_name("AllocationIds"),
