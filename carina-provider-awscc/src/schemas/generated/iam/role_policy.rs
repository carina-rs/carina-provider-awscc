...
pub fn iam_role_policy_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        primary_identifier: &[crate::schemas::config::PrimaryIdentifierAttribute { provider_name: "PolicyName", dsl_name: "policy_name" }, crate::schemas::config::PrimaryIdentifierAttribute { provider_name: "RoleName", dsl_name: "role_name" }],
        has_tags: false,
...
pub fn required_permissions(op: carina_core::effect::PlanOp) -> &'static [&'static str] {
    match op {
        carina_core::effect::PlanOp::Create => &["iam:PutRolePolicy", "iam:GetRolePolicy"],
        carina_core::effect::PlanOp::Read => &["iam:GetRolePolicy"],
        carina_core::effect::PlanOp::Update => &["iam:PutRolePolicy", "iam:GetRolePolicy"],
        carina_core::effect::PlanOp::Delete => &["iam:DeleteRolePolicy", "iam:GetRolePolicy"],
    }
}
