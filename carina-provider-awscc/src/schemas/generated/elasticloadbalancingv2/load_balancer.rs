...
const VALID_ENABLE_PREFIX_FOR_IPV6_SOURCE_NAT: &[&str] = &["dualstack", "off"];

const VALID_IP_ADDRESS_TYPE: &[&str] = &["ipv4", "dualstack", "dualstack-without-public-ipv4"];

const VALID_LOAD_BALANCER_ATTRIBUTE_KEY: &[&str] = &[
    "true",
    "false",
    "monitor",
    "defensive",
...
pub fn elasticloadbalancingv2_load_balancer_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("enable_prefix_for_ipv6_source_nat", AttributeType::string_enum("EnablePrefixForIpv6SourceNat".to_string(), vec!["dualstack".to_string(), "off".to_string()], Some(carina_core::schema::string_enum_identity("EnablePrefixForIpv6SourceNat", Some("awscc.elasticloadbalancingv2.LoadBalancer"))), vec![("dualstack".to_string(), "dualstack".to_string()), ("off".to_string(), "off".to_string())]))
        ...
        .attribute(
            AttributeSchema::new("enforce_security_group_inbound_rules_on_private_link_traffic", AttributeType::string())
        ...
        .attribute(
            AttributeSchema::new("ip_address_type", AttributeType::string_enum("IpAddressType".to_string(), vec!["ipv4".to_string(), "dualstack".to_string(), "dualstack-without-public-ipv4".to_string()], Some(carina_core::schema::string_enum_identity("IpAddressType", Some("awscc.elasticloadbalancingv2.LoadBalancer"))), vec![("ipv4".to_string(), "ipv4".to_string()), ("dualstack".to_string(), "dualstack".to_string()), ("dualstack-without-public-ipv4".to_string(), "dualstack_without_public_ipv4".to_string())]))
        ...
        .attribute(
            AttributeSchema::new("scheme", AttributeType::string())
                .create_only()
        ...
        .attribute(
            AttributeSchema::new("subnet_mappings", AttributeType::unordered_list(AttributeType::struct_("SubnetMapping".to_string(), vec![StructField::new("allocation_id", super::allocation_id()).with_description("[Network Load Balancers] The allocation ID of the Elastic IP address for an internet-facing load balancer.").with_provider_name("AllocationId"),
                    ...
                    StructField::new("subnet_id", super::subnet_id()).required().with_description("The ID of the subnet.").with_provider_name("SubnetId")])))
...
pub fn enum_valid_values() -> (
    ...
    (
        ...
        &[
            ...
            ("key", VALID_LOAD_BALANCER_ATTRIBUTE_KEY),
        ],
    )
}
