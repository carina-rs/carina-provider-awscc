...
pub fn elasticloadbalancingv2_load_balancer_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("enable_prefix_for_ipv6_source_nat", AttributeType::enum_(carina_core::schema::enum_identity("EnablePrefixForIpv6SourceNat", Some("awscc.elasticloadbalancingv2.LoadBalancer")), Some(vec!["dualstack".to_string(), "off".to_string()]), vec![("dualstack".to_string(), "dualstack".to_string()), ("off".to_string(), "off".to_string())], None, None))
