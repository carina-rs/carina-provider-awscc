...
pub fn route53_hosted_zone_config() -> AwsccSchemaConfig {
    AwsccSchemaConfig {
        ...
        .attribute(
            AttributeSchema::new("hosted_zone_config", AttributeType::ref_("HostedZoneConfig".to_string()))
        ...
        .attribute(
            AttributeSchema::new("hosted_zone_features", AttributeType::ref_("HostedZoneFeatures".to_string()))
        ...
        .attribute(
            AttributeSchema::new("query_logging_config", AttributeType::ref_("QueryLoggingConfig".to_string()))
